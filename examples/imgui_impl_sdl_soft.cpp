...
static void ImGui_ImplSdlSoft_SetupRenderState(ImDrawData* draw_data, int fb_width, int fb_height)
{
...
void ImGui_ImplSdlSoft_RenderDrawData(ImDrawData* draw_data)
{
	...
	ImGui_ImplSdlSoft_SetupRenderState(draw_data, fb_width, fb_height);
...
bool ImGui_ImplSdlSoft_CreateFontsTexture()
{
	// Build texture atlas
	ImGuiIO& io = ImGui::GetIO();
...
{
	return ImGui_ImplSdlSoft_CreateFontsTexture();
}
